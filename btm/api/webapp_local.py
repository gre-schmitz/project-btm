...
url_predict = 'http://localhost:8000/prediction_set'
...
def App():
    ...
    st.markdown("Let us introduce [our concept](#Info).")
...
selection = st.sidebar.radio("Go to", ["Computations", "Background Information"])

# Display content based on the selected page
if selection == "Computations":
    App()
elif selection == "Background Information":
    Info()
